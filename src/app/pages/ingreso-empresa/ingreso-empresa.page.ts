...
import { EmpresaAccordion } from '../../components/empresa-accordion/empresa-accordion';
...
@Component({
  ...
  imports: [LucideAngularModule, FormsModule,EmpresaAccordion, RouterLink, CommonModule],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './ingreso-empresa.page.html',
