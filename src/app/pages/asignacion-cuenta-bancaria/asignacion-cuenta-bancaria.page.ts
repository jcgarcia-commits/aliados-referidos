...
import { UpsertCuentaBancaria } from '../../components/upsert-cuenta-bancaria/upsert-cuenta-bancaria';
import { UpsertAsignaCuenta } from '../../components/upsert_asigna_cuenta/upsert_asigna_cuenta';
...
@Component({
  ...
  imports: [LucideAngularModule, FormsModule,RouterLink, CommonModule, UpsertCuentaBancaria, UpsertAsignaCuenta],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './asignacion-cuenta-bancaria.page.html',
