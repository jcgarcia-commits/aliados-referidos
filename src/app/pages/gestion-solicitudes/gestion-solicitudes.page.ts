...
import { GestionaSolicitudes } from '../../components/gestiona-solicitudes/gestiona-solicitudes';
...
@Component({
  selector: 'app-test-page',
    imports: [LucideAngularModule, FormsModule,RouterLink, CommonModule, GestionaSolicitudes],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './gestion-solicitudes.page.html',
