...
import { UpsertTipoRespuesta } from '../../components/upsert-tipo-respuesta/upsert-tipo-respuesta';
...
@Component({
  selector: 'app-test-page',
    imports: [LucideAngularModule, FormsModule,RouterLink, CommonModule, UpsertTipoRespuesta],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './tipo-respuesta-mant.page.html',
...
export default class GestionSolicitudesPageComponent {
 ...
 readonly SquarePen = SquarePen;
  ...
  openModal(nuevo: boolean = true, empresa: IEmpresa = emptyEmpresa) {
    ...
    this.modal.set({ titulo: nuevo ? 'Crear Tipo Respuesta' : 'Actualizar Tipo Respuesta', visible: true });    
  }
