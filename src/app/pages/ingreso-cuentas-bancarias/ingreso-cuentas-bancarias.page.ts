...
@Component({
  ...
  imports: [LucideAngularModule, UpsertCuentaBancaria, FormsModule, CommonModule],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './ingreso-cuentas-bancarias.page.html',
 ...
 searchMode: 'nombre' | 'documento' = 'nombre';
  ...
  nuevoEmpresa = signal(true)
     ...
     openModal(nuevo: boolean = true, empresa: IEmpresa = emptyEmpresa) {
       ...
       this.modal.set({ titulo: nuevo ? 'Crear Cuenta' : 'Asociar Cuenta', visible: true });    
     }
