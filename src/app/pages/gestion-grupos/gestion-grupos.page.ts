...
import { UpsertGrupo } from '../../components/upsert-grupo/upsert-grupo';
...
@Component({
  selector: 'app-test-page',
    imports: [LucideAngularModule, FormsModule,RouterLink, CommonModule, UpsertGrupo],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './gestion-grupos.page.html',
...
export default class GestionSolicitudesPageComponent {
  ...
  readonly SquarePen = SquarePen;
   ...
   estado: true,
     ...
     {
       empresaId: '4',
       nombre: 'CUENTA BANCARIA CORRECTA',
       direccion: '3',
       nit: '0',
       telefono: '0',
       orden: '0',
   ...
   openModal(nuevo: boolean = true, empresa: IEmpresa = emptyEmpresa) {
     ...
     this.modal.set({ titulo: nuevo ? 'Crear Grupo' : 'Actualizar Grupo', visible: true });    
   }
