...
import { UpsertTipoSolicitud } from '../../components/upsert-tipo-solicitud/upsert-tipo-solicitud';
...
@Component({
  selector: 'app-test-page',
    imports: [LucideAngularModule, FormsModule,RouterLink, CommonModule, UpsertTipoSolicitud],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './tipo-solicitud-mant.page.html',
...
export default class GestionSolicitudesPageComponent {
 ...
 readonly SquarePen = SquarePen;
  ...
  empresasList = signal<IEmpresa[]>([
    ...
    {
      empresaId: '2',
      nombre: 'Actualización de Cuenta Bancaria',
  ...
  openModal(nuevo: boolean = true, empresa: IEmpresa = emptyEmpresa) {
    ...
    this.modal.set({ titulo: nuevo ? 'Crear tipo solicitud' : 'Actualizar tipo solicitud', visible: true });    
  }
