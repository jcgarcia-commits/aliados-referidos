...
@Component({
  selector: 'app-upsert-objeto-respuesta',
  imports: [],
  templateUrl: './upsert-objeto-respuesta.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UpsertObjetoRespuesta implements OnInit {
  ...
  ngOnInit(): void { }
    ...
    fb = inject(FormBuilder);
      ...
      get btnText(): string {
        return this.nuevo() ? 'Crear tipo de Respuesta' : 'Actualizar tipo de Respuesta';
      }
