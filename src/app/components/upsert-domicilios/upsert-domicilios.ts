...
@Component({
  selector: 'app-upsert-domicilios',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './upsert-domicilios.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UpsertDomicilios  implements OnInit {
  ...
  get btnText(): string {
    return this.nuevo() ? 'Crear domicilio' : 'Actualizar domicilio';
  }
