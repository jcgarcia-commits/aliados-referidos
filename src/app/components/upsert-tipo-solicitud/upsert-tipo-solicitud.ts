...
@Component({
  selector: 'app-upsert-tipo-solicitud',
  imports: [],
  templateUrl: './upsert-tipo-solicitud.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UpsertTipoSolicitud implements OnInit {
  ...
  fb = inject(FormBuilder);
    ...
    get btnText(): string {
      return this.nuevo() ? 'Crear tipo de Solicitud' : 'Actualizar tipo de Solicitud';
    }
