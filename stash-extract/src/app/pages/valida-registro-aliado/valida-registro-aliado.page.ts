...
import { GestionAprobacion } from '../../components/gestion-aprobacion/gestion-aprobacion';
...
@Component({
  selector: 'app-test-page',
    imports: [LucideAngularModule, FormsModule,RouterLink, CommonModule, GestionAprobacion],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './valida-registro-aliado.page.html',
